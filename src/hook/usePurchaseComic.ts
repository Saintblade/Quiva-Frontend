...
//   //     console.log({ comicId, address, rec: receipt.transactionHash });
//   //     updateBackendData(
//   //       comicId || "",
//   //       address || "",
//   //       receipt.transactionHash,
...
//     pricePerToken,
//   }: PurchaseParams) => {
//     alert("we are buying now 1");
//     if (!isConnected || !address) {
//       throw new Error("Please connect your wallet first");
//     }

//     alert("we are buying now 2");
//     if (chainId !== 296) {
//       throw new Error("Please switch to Hedera Testnet");
//     }

//     alert("we are buying now 3");
//     try {
//       setIsPurchasing(true);
//       setPurchaseError(null);
//       setPurchaseSuccess(false);
//       alert("we are buying now 4");

//       const currentChain = chainId === 296 ? hederaTestnet : mainnet;
//       // Calculate total price
//       const totalPrice = pricePerToken * amount;

//       alert("we are buying now 5");
//       console.log("💰 Purchasing comic:", {
//         tokenId: tokenId.toString(),
//         seller,
//         amount: amount.toString(),
...
//       });
//       console.log("call update backend Purchase transaction sent");
//       if (isComicSuccess) {
//         alert("we are buying now  isComicSuccess 8");
//         updateBackendData(
//           comicId || "",
//           address || "",
//           "receipt.transactionHash",
...
//       console.log(
//         "✅ Transaction updated with tokenId, hash, walletAddress data"
//       );
//     } catch (error) {
