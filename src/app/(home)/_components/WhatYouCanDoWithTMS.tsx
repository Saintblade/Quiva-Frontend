					...
					<div className='mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16'>
						{features.map(({ id, title, description, gradient }) => (
							...
							>
								...
								/>
								<div className='relative  px-6 pt-16 pb-24 space-y-4 font-recursive'>
									<div className='size-24 absolute -top-8 shadow-custom-orange flex items-center justify-center bg-black-100 text-white text-5xl font-bold rounded-xl mb-4 font-recursive'>
										{id}
									</div>
