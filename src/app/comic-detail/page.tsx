...
// const RelatedIssueCard = ({ issue }: { issue: RelatedIssue }) => (
// 	<div className='relative group cursor-pointer'>
// 		<div className='relative overflow-hidden rounded-lg bg-gray-900 aspect-[3/4] border border-gray-700/50 hover:border-gray-600/60 transition-all duration-200'>
// 			{issue.isFree && (
// 				<div className='absolute top-2 left-2 z-10 bg-green-600 text-white text-xs font-bold px-2 py-1 rounded-md'>
// 					Free
// 				</div>
// 			)}
// 			<img
		...
		relatedIssues: [
			{
				...
				coverImage:
					"https://images.unsplash.com/photo-1578662015905-6a4c1d4e8f0a?w=300&h=400&fit=crop",
			...
			},
			{
				...
				coverImage:
					"https://images.unsplash.com/photo-1569003339405-ea396a5a8a90?w=300&h=400&fit=crop",
			...
			},
			{
				...
				coverImage:
					"https://images.unsplash.com/photo-1578662019011-c85d8b2b8b6d?w=300&h=400&fit=crop",
			...
			},
			{
				...
				coverImage:
					"https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=300&h=400&fit=crop",
