...
export const QUIVA_COMICS_ADDRESS = '0x35eE78eB3918Ac7181b2Fd16dA068a3241C06B54' as `0x${string}`;
		...
		"outputs": [
			{
				...
				"internalType": "struct QuivaComics.Comic",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct QuivaComics.Listing",
				"name": "",
				"type": "tuple"
			}
		],
